...
class Backoffice::AttachmentsControllerTest < ActionController::TestCase
  def test_index
    get :index
  ...
  def test_create_valid
    ...
    post :create
    assert_redirected_to backoffice_attachment_url(assigns(:attachment))
  end
  ...
  def test_destroy
    ...
    assert_redirected_to backoffice_attachments_url
